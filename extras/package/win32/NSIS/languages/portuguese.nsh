...
StrCpy $Reinstall_OptionUpgrade "Atualizar o VLC, utilizando as definições anteriores (recomendado)"
StrCpy $Reinstall_OptionDowngrade "Instalar uma versão anterior do VLC, utilizando as definições anteriores (recomendado)"
